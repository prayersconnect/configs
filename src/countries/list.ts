...
const countries: ICountries = {
  AD: {
    aliases: ['Principality of the Valleys of Andorra'],
    alpha2: 'AD',
    alpha3: 'AND',
    fifa: 'AND',
    ioc: 'AND',
  ...
  BM: {
    aliases: ['Bermudas', 'Somers Isles', 'The Bermudas', 'The Somers Isles'],
    alpha2: 'BM',
    alpha3: 'BMU',
    fifa: 'BER',
    ioc: 'BER',
  ...
  CM: {
    aliases: ['Cameroun', 'Cameroon, Republic of'],
    alpha2: 'CM',
    alpha3: 'CMR',
    fifa: 'CMR',
    ioc: 'CMR',
  ...
  GW: {
    aliases: ['Guinea Bissau', 'Republic of Guinea Bissau'],
    alpha2: 'GW',
    alpha3: 'GNB',
    fifa: 'GNB',
    ioc: 'GBS',
  ...
  HK: {
    aliases: ['Hong Kong Special Administrative Region'],
    alpha2: 'HK',
    alpha3: 'HKG',
    fifa: 'HKG',
    ioc: 'HKG',
  ...
  KN: {
    aliases: ['Federation of Saint Christopher and Nevi'],
    alpha2: 'KN',
    alpha3: 'KNA',
    fifa: 'SKN',
    ioc: 'SKN',
  ...
  KP: {
    aliases: ['DPRK', 'N Korea', 'N. Korea', 'Korea, North'],
    alpha2: 'KP',
    alpha3: 'PRK',
    fifa: 'PRK',
    ioc: 'PRK',
  ...
  KR: {
    aliases: ['S Korea', 'S. Korea', 'Korea, South'],
    alpha2: 'KR',
    alpha3: 'KOR',
    fifa: 'KOR',
    ioc: 'KOR',
  ...
  MO: {
    aliases: ['Macao', 'Macao Special Administrative Region'],
    alpha2: 'MO',
    alpha3: 'MAC',
    fifa: null,
    ioc: null,
  ...
  PS: {
    aliases: ['Palestinian Territories', 'Palestinian Territory'],
    alpha2: 'PS',
    alpha3: 'PSE',
    fifa: 'PLE',
    ioc: 'PLE',
  ...
  SM: {
    aliases: ['Most Serene Republic of San Marino'],
    alpha2: 'SM',
    alpha3: 'SMR',
    fifa: 'SMR',
    ioc: 'SMR',
  ...
  SZ: {
    aliases: ['Ngwane', 'Swatini', 'Swaziland', 'Kingdom of Swaziland'],
    alpha2: 'SZ',
    alpha3: 'SWZ',
    fifa: 'SWZ',
    ioc: 'SWZ',
  ...
  TF: {
    aliases: ['French Southern and Antarctic Lands'],
    alpha2: 'TF',
    alpha3: 'ATF',
    fifa: null,
    ioc: null,
  ...
  UY: {
    aliases: ['Eastern Republic of Uruguay'],
    alpha2: 'UY',
    alpha3: 'URY',
    fifa: 'URU',
    ioc: 'URU',
  ...
  VI: {
    aliases: ['USVI', 'US Virgin Islands', 'United States Virgin Islands'],
    alpha2: 'VI',
    alpha3: 'VIR',
    fifa: 'VIR',
    ioc: 'ISV',
