...
describe('daylight savings', () => {
  describe('getDSTStart', () => {
    ...
    it('returns start date for valid country and year', () => {
      expect(getDSTStart('United States', 2022)).toEqual(
        new Date('2022-03-13')
      );
      expect(getDSTStart('Canada', 2022)).toEqual(new Date('2022-03-13'));
      expect(getDSTStart('United Kingdom', 2022)).toEqual(
        new Date('2022-03-27')
      );
      expect(getDSTStart('Australia', 2022)).toEqual(new Date('2022-10-02'));
    });
