...
var getCalcMethodsByCountry = function (country) {
    ...
    if (country) {
        ...
        return {
            method: ((_a = countryConf === null || countryConf === void 0 ? void 0 : countryConf.prayer_settings) === null || _a === void 0 ? void 0 : _a.calculation_method) || null,
            asrMethod: ((_b = countryConf === null || countryConf === void 0 ? void 0 : countryConf.prayer_settings) === null || _b === void 0 ? void 0 : _b.asr_method) || 'Standard',
        };
    }
    return {
        method: null,
